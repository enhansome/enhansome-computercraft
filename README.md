...
* [`cc-mek-scada`](https://github.com/MikaylaFischler/cc-mek-scada) ⭐ 575 | 🐛 16 | 🌐 Lua | 📅 2026-09-21 - Configurable control system for Mekanism fission reactors.
...
* [Awesome CC: Tweaked](https://github.com/Shlomo1412/awesome-cctweaked) ⭐ 32 | 🐛 0 | 📅 2026-09-18 - An Awesome list which only lists things relevant to CC: Tweaked.
