...
* [Mildly Better Shell (MBS)](https://github.com/SquidDev-CC/mbs) ⭐ 84 | 🐛 6 | 🌐 Lua | 📅 2023-12-08 -  An improved shell that includes scrollback and improved resolution of completions.
...
* [CCVim](https://github.com/Minater247/CCVim/tree/rewrite-2026) ⭐ 31 | 🐛 2 | 🌐 Lua | 📅 2026-06-01 - A faithful port of Vim for ComputerCraft.
...
* [`cc-mek-scada`](https://github.com/MikaylaFischler/cc-mek-scada) ⭐ 571 | 🐛 15 | 🌐 Lua | 📅 2026-08-09 - Configurable control system for Mekanism fission reactors.
...
* [Cloud Catcher](https://github.com/SquidDev-CC/cloud-catcher) ⭐ 85 | 🐛 10 | 🌐 TypeScript | 📅 2024-12-08 -  A program which enables interaction with computers outside of the game.
...
* [Awesome Lua](https://github.com/LewisJEllis/awesome-lua) ⭐ 4,551 | 🐛 47 | 📅 2024-08-11 - An Awesome list specific to the Lua programming language.
